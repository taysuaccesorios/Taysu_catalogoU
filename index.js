...
function slideDer() {
    ...
    $(".pages").hide(); $('.posicion-boton').hide(); $('.tri_l').removeClass('no-event'); $('.tri_r').removeClass('no-event');
...
function slideIzq() {
    ...
    $(".pages").hide(); $('.posicion-boton').hide(); $('.tri_r').removeClass('no-event'); $('.tri_l').removeClass('no-event');
...
var cambioBoton = 0;
var nameVendedor = document.getElementById('vendedor');
...
function getElement(num) {
	...
	var link2 = "text=hola%20Camila,%20quiero%20saber%20que%20pa%C3%B1oletas%20"+talla+"%20tiene%20para%20mi%20peludito?("+vendedor+")"
	var link3 = link1+link2;
	window.open(link3, '_blank');

    } else if (num == 2) {
	
	var link2 = "text=hola%20Camila,%20quiero%20una%20pa%C3%B1oleta%20personalizada%20"+talla+"%20para%20mi%20peludito("+vendedor+")"
	var link3 = link1+link2;
	window.open(link3, '_blank');

    } else if (num == 3) {
	
	var link2 = "text=hola%20Camila,%20quiero%20preguntar%20por%20saquitos%20"+talla+"%20para%20mi%20peludito?("+vendedor+")"
	var link3 = link1+link2;
	window.open(link3, '_blank');
